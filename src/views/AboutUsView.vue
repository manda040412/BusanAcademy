...
const mockData = [
  { rank: 8, name: "University Of California, Berkeley (QS #17)", latitude: 37.8719, longitude: -122.2585 },
  { rank: 9, name: "Imperial College London (QS #2)", latitude: 51.4988, longitude: -0.1749 },
  { rank: 10, name: "Yale University (QS #21)", latitude: 41.3163, longitude: -72.9223 },
  { rank: 14, name: "University Of Pennsylvania (QS #15)", latitude: 39.9522, longitude: -75.1932 },
  { rank: 17, name: "National University of Singapore (QS #8)", latitude: 1.2966, longitude: 103.7764 },
  { rank: 18, name: "Columbia University (QS #38)", latitude: 40.8075, longitude: -73.9626 },
  { rank: 19, name: "University Of California, Los Angeles (QS #46)", latitude: 34.0689, longitude: -118.4452 },
  { rank: 20, name: "Cornell University (QS #16)", latitude: 42.4534, longitude: -76.4735 },
  { rank: 21, name: "University Of Toronto (QS #29)", latitude: 43.6629, longitude: -79.3957 },
  { rank: 22, name: "University College London (QS #22)", latitude: 51.5246, longitude: -0.1340 },
  { rank: 23, name: "University of Michigan-Ann Arbor (QS #45)", latitude: 42.2780, longitude: -83.7382 },
  { rank: 25, name: "University Of Washington (QS #81)", latitude: 47.6553, longitude: -122.3035 },
  { rank: 30, name: "Nanyang Technological University (QS #12)", latitude: 1.3483, longitude: 103.6831 },
  { rank: 31, name: "Northwestern University (QS #42)", latitude: 42.0565, longitude: -87.6753 },
  { rank: 33, name: "New York University (QS #55)", latitude: 40.7295, longitude: -73.9965 },
  { rank: 34, name: "University Of California, San Diego (QS #66)", latitude: 32.8801, longitude: -117.2340 },
  { rank: 35, name: "University Of Hong Kong (QS #11)", latitude: 22.2829, longitude: 114.1367 },
  { rank: 36, name: "LMU Munich (QS #58)", latitude: 48.1507, longitude: 11.5810 },
  { rank: 39, name: "University Of Melbourne (QS #19)", latitude: -37.7964, longitude: 144.9612 },
  { rank: 41, name: "University Of British Columbia (QS #40)", latitude: 49.2606, longitude: -123.2460 },
  { rank: 44, name: "Chinese University Of Hong Kong (QS #32)", latitude: 22.4196, longitude: 114.2068 },
  { rank: 46, name: "University Of Illinois At Urbana-Champaign (QS #70)", latitude: 40.1020, longitude: -88.2272 },
  { rank: 50, name: "University Of Texas At Austin (QS #68)", latitude: 30.2849, longitude: -97.7341 },
  { rank: 53, name: "University Of Manchester (QS #35)", latitude: 53.4668, longitude: -2.2339 },
  { rank: 56, name: "University Of Wisconsin-Madison (QS #110)", latitude: 43.0766, longitude: -89.4125 },
  { rank: 58, name: "Brown University (QS #69)", latitude: 41.8268, longitude: -71.4025 },
  { rank: 59, name: "Monash University (QS #36)", latitude: -37.9144, longitude: 145.1300 },
  { rank: 61, name: "University Of Sydney (QS #25)", latitude: -33.8886, longitude: 151.1873 },
  { rank: 66, name: "The Hong Kong University Of Science And Technology (QS #44)", latitude: 22.3363, longitude: 114.2635 },
  { rank: 67, name: "University Of California, Santa Barbara (QS #179)", latitude: 34.4140, longitude: -119.8489 },
];
